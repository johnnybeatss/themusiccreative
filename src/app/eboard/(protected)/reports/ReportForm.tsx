      ...
      <div className="grid gap-3 sm:grid-cols-2">
        ...
        <label className="block text-sm">
          ...
          <input
            ...
            className="mt-1 w-full rounded-md border border-navy-800 bg-navy-950 px-3 py-2 text-sm text-ivory placeholder:text-steel-light/60 focus:border-gold focus:outline-none"
          />
        </label>
      </div>
      <label className="block text-sm">
